...
class TemplateController extends OCSController {
	...
	public function list(): DataResponse {
		return new DataResponse(array_map(static function (array $template) {
			$template['templates'] = array_map(static fn (Template $template) => $template->jsonSerialize(), $template['templates']);
			return $template;
